...
with st.expander("📸 내 기본 건설 속도 확인 방법 가이드"):
    st.image("e5a6193c-a5ac-4345-bdad-c3e34a6e603d.png", caption="건설 속도 확인 위치 예시", use_column_width=True)
    st.markdown("""
    **확인 경로:**  
...
with st.form("input_form"):
    ...
    hyena = st.selectbox("하이에나 (Pet Skill) %", [0, 5, 7, 9, 12, 15], index=5) / 100
